...
def get_books_with_tags(db_path, allowed_tags=["AI", "ML", "DL", "NLP", "LLM"]):
    """
    Fetches book paths and their combined tags from Calibre.
    """
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        for row in cursor.fetchall():
            rel_path, file_name, extension, all_tags = row
            ...
            if all_tags:
                ...
                if any(tag in tag_list for tag in allowed_tags):
                    ...
                    books_data.append((full_path, all_tags))
